...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |KeyPad|Adjust| Alt  | GUI  | LANG8| Lower| Space| Space| Raise| LANG9| GUI  | Alt  |GuiSft|Enter |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_DVORAK] = LAYOUT( \
  ...
  [_RAISE] = LAYOUT( \
      ...
      KC_TILD, KC_EXLM, KC_AT,      KC_HASH,    KC_DLR,     KC_PERC,                   KC_PGUP, LCTL(KC_A), KC_UP,   LCTL(KC_E), KC_F15,  KC__VOLUP, \
      _______, _______, LGUI(KC_C), LGUI(KC_X), LGUI(KC_V), _______,                   KC_PGDN, KC_LEFT,    KC_DOWN, KC_RGHT,    KC_F14,  KC__VOLDOWN, \
