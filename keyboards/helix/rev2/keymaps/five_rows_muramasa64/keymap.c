...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( \
      ...
      KC_LSFT,  KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,  EISU, KANA, KC_N,    KC_M,   KC_COMM, KC_DOT, KC_SLSH, RSFT_T(KC_GRV), \
      MO(_KEYPAD), MO(_ADJUST), KC_LALT, KC_LGUI, EISU, MO(_LOWER), MO(_RAISE), \
                                                   SFT_T(KC_SPC), LT(_RAISE,KC_ENT), KANA, KC_RGUI, KC_RALT, MO(_LOWER), KC_ENT \
      ),
   ...
   * | Tab  |   '  |   ,  |   .  |   P  |   Y  |             |   F  |   G  |   C  |   R  |   L  |  /   |
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
   * | Ctrl |   A  |   O  |   E  |   U  |   I  |             |   D  |   H  |   T  |   N  |   S  |-(CTL)|
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * | Shift|   ;  |   Q  |   J  |   K  |   X  | EISU | KANA |   B  |   M  |   W  |   V  |   Z  |`(SFT)|
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |KEYPAD|Adjust| Alt  | GUI  | LANG8| Lower| Raise| Space| Raise| LANG9| GUI  | Alt  | Lower|Enter |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_DVORAK] = LAYOUT( \
      ...
      KC_LCTL, KC_A,    KC_O,    KC_E,    KC_U,    KC_I,              KC_D,    KC_H,    KC_T,    KC_N,    KC_S, RCTL_T(KC_MINS), \
      KC_LSFT, KC_SCLN, KC_Q,    KC_J,    KC_K,    KC_X, EISU, KANA,  KC_B,    KC_M,    KC_W,    KC_V,    KC_Z, RSFT_T(KC_GRV), \
      MO(_KEYPAD), MO(_ADJUST), KC_LALT, KC_LGUI, EISU, MO(_LOWER), MO(_RAISE), \
                                                   SFT_T(KC_SPC), LT(_RAISE,KC_ENT), KANA, KC_RGUI, KC_RALT, MO(_LOWER), KC_ENT \
      ),
   ...
   */
  [_KEYPAD] = LAYOUT( \
      _______,  _______, _______, _______, _______, _______,                   KC_PSLS, KC_DQT, KC_PERC, S(KC_Z), _______, _______, \
      _______,  _______, _______, _______, _______, _______,                   KC_PAST, KC_P7,  KC_P8,   KC_P9,   KC_D,    KC_Y, \
      _______,  _______, _______, _______, _______, _______,                   KC_PMNS, KC_P4,  KC_P5,   KC_P6,   KC_I,    KC_H, \
      _______,  _______, _______, _______, _______, _______, _______, _______, KC_PPLS, KC_P1,  KC_P2,   KC_P3,   KC_A,    KC_N, \
  ...
  [_LOWER] = LAYOUT( \
      ...
      _______, _______, _______,       _______,       _______, _______, _______, KC_TILD, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_GRV, \
      _______, _______, _______,       _______,       _______, _______, _______, KC_DQT,  _______, _______, _______, _______, _______, _______ \
      ),
  ...
  [_RAISE] = LAYOUT( \
      ...
      _______, _______, _______, LGUI(KC_I), _______,    _______,                   _______, KC_HOME, KC_UP,   KC_END,  _______, _______, \
      _______, _______, _______, LGUI(KC_B), LGUI(KC_DOT), _______,                   _______, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, \
