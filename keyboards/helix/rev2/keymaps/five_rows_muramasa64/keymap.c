...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_RAISE] = LAYOUT( \
      ...
      _______, _______, _______, LGUI(KC_C), _______,    _______,                   KC_DEL,  KC_HOME, KC_UP,   KC_END,  _______, _______, \
      _______, _______, _______, LGUI(KC_X), LGUI(KC_V), _______,                   KC_BSPC, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, \
