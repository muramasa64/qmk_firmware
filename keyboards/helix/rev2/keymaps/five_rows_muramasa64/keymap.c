...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
   * |      |      |      | Copy |      |      |             |  Del | Home |  Up  | End  |      | Mute |
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
   * |      |      |      | Cut  | Paste|      |             |  BS  | Left | Down |Right | Lit+ | Vol+ |
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |      |      |      |      |      |      |      |      |      |      |PageUp|PageDn| Lit- | Vol- |
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |      |      |      |      |      |      |Raise |      |Raise |      |      |      |      |      |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_RAISE] = LAYOUT( \
      ...
      _______, _______, _______, LGUI(KC_C), _______,    _______,                   KC_DEL,  KC_HOME, KC_UP,   KC_END,  ______,  KC__MUTE, \
      _______, _______, _______, LGUI(KC_X), LGUI(KC_V), _______,                   KC_BSPC, KC_LEFT, KC_DOWN, KC_RGHT, KC_F15,  KC__VOLUP, \
      _______, _______, _______, _______,    _______,    _______, _______, _______, _______, _______, KC_PGUP, KC_PGDN, KC_F14,  KC__VOLDOWN, \
      _______, _______, _______, _______,    _______,    _______, _______, _______, _______, _______, _______, _______, _______, _______ \
      ),
