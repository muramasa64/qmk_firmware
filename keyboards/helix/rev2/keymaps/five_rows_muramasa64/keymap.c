...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT( \
      ...
      _______, _______, LGUI(KC_UNDS), LGUI(KC_PLUS), _______, _______,                  KC_MINS, KC_EQL,  KC_LPRN, KC_RPRN, KC_PIPE,    KC_Q, \
   ...
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
   * |      |      |      | Copy |      |      |             |  Del | Home |  Up  | End  |      |      |
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
   * |      |      |      | Cut  | Paste|      |             |  BS  | Left | Down |Right |      |      |
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |      |      |      |      |      |      |      |      |      |      |PageUp|PageDn|      |      |
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |      |      |      |      |      |      |Raise |      |Raise |      |      |      |      |      |
  ...
  [_RAISE] = LAYOUT( \
      ...
      _______, _______, _______, LGUI(KC_I), _______,      _______,                   KC_DEL,  KC_HOME, KC_UP,   KC_END,  _______, _______, \
      _______, _______, _______, LGUI(KC_B), LGUI(KC_DOT), _______,                   KC_BSPC, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, \
  ...
  [_ADJUST] =  LAYOUT( \
      KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,                     KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12, \
      _______, RESET,   RGBRST,  _______, _______, _______,                   AG_NORM, QWERTY,  _______, _______, _______, KC_DEL, \
