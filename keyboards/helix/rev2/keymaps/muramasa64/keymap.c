...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * | Shift|   Z  |   X  |   C  |   V  |   B  |   -  |   =  |   N  |   M  |   ,  |   .  |   /  | `    |
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |Adjust|      | Alt  | GUI  | EISU |Space |Lower |Raise |Space | KANA | GUI  |  Alt |      |Enter |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_QWERTY] = KEYMAP( \
      ...
      ADJUST,  XXXXXXX, KC_LALT, KC_LGUI, EISU, KC_SPC, LOWER,   RAISE,  KC_SPC, KANA, KC_RGUI, KC_RALT, XXXXXXX, KC_ENT \
      ),
