...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( \
      ...
      KC_LSFT, KC_Z,   KC_X,    KC_C,    KC_V, KC_B,  XXXXXXX, XXXXXXX,       KC_N,  KC_M, KC_COMM, KC_DOT,  KC_SLSH, RSFT_T(KC_GRV) , \
  ...
  [_DVORAK] = LAYOUT( \
      ...
      KC_LSFT, KC_SCLN, KC_Q,    KC_J,    KC_K, KC_X,  XXXXXXX, XXXXXXX,       KC_B,  KC_M, KC_W,    KC_V,    KC_Z,  RSFT_T(KC_GRV) , \
      KEYPAD,  ADJUST,  KC_LALT, KC_LGUI, EISU, LOWER, RAISE,   SFT_T(KC_SPC), RAISE, KANA, KC_RGUI, KC_RALT, LOWER, KC_ENT \
      ),
