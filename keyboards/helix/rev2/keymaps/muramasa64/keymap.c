...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |Adjust|Lower |      | Alt  | GUI  | HENK |Space |Space | MHEN | GUI  |  Alt |      |Raise |Enter |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_QWERTY] = KEYMAP( \
      ...
      ADJUST,  LOWER, XXXXXXX, KC_LALT, KC_LGUI, KC_HENK, KC_SPC, KC_SPC, KC_MHEN, KC_RGUI, KC_RALT  XXXXXXX, RAISE,   KC_ENT \
      ),
